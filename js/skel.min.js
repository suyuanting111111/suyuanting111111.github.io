...
var skel = function ()
{
    var e = "breakpoints", t = "config", n = "iterate", r = "elements", i = "stateId", s = "stateElements",
        ...
        c = "getCachedElement", h = "viewport", p = " 0 -1px ", d = "cacheNewElement", v = "config_breakpoint", m = !0,
        g = "createElement", y = "gutters", b = "vars", w = "insertBefore", E = "newInline", S = "}", x = "cache",
        T = "parentNode", N = "orientationChange", C = "substring", k = "locations", L = "deviceType", A = "className",
        O = " 0 0 ", M = "object", _ = "isArray", D = "match", P = "+*,", H = "replace", B = "head", j = "newElement",
        F = "canUseProperty_element", I = "indexOf", q = "_skel_isReversed", R = "push", U = "extend", z = "grid",
        W = "matchesMedia", X = "containers", V = "maxGridZoom", $ = "onorientationchange", J = "defaults",
        K = "DOMReady", Q = "lock", G = "getComputedStyle", Y = "addEventListener", Z = "^head",
        et = "{display:none!important}", tt = "registerLocation", nt = "parseMeasurement", rt = "documentElement",
        it = "placeholder", st = "events", ot = "IEVersion", ut = "attachElements", at = "charAt", ft = "plugins",
        lt = "attachElement", ct = "isActive", ht = "DOMContentLoaded", pt = "text/css", dt = "device-width",
        vt = "states", mt = "_skel_attach", gt = "initial-scale=1", yt = "trigger", bt = "removeEventListener",
        wt = "previousSibling", Et = "media", St = "resize", xt = "attached", Tt = "normalize",
        Nt = "applyRowTransforms", Ct = "collapse", kt = "change", Lt = "location", At = "(min-width: ", Ot = "split",
        Mt = "forceDefaultState", _t = "style", Dt = "html", Pt = "_skel_placeholder", Ht = "firstChild",
        Bt = "querySelectorAll", jt = "min-height", Ft = "max-height", It = "innerHTML", qt = "min-width",
        Rt = "prototype", Ut = "max-width", zt = "domready", Wt = "hasOwnProperty", Xt = "nextSibling", Vt = "height=",
        $t = "zoom", Jt = "href", Kt = "isStatic", Qt = "android", Gt = "readyState", Yt = ".\\3$1 ", Zt = "onresize",
        en = "priority", tn = {
            breakpoints: [],
            breakpointList: [],
            ...
            initUtilityMethods: function ()
            {
                ...
                }(zt, function (e)
                {
                    ...
                    var n = [], r, i = !1, s = document, o = s[rt], u = o.doScroll, a = ht, f = Y, l = "onreadystatechange",
                        c = Gt, h = u ? /^loaded|^c/ : /^loaded|c/, p = h.test(s[c]);
